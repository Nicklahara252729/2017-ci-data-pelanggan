<div class="container-fluid bg-putih padding" style="box-shadow:0px 0px 5px 0px gray;border-bottom:solid 2px #ef2470;">
    ...
    <div class="col-lg-6 padding">
        ...
        <div class="col-lg-3 f-40">
            <?php echo anchor('pulsa/','PULSA',['style'=>'color:black']); ?>
    </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <table class="table">
            ...
            <tr>
                <td>Jenis</td>
                <td>:</td>
                <td><input type="text" name="jenis" class="form-control" value="PULSA" readonly></td>
            </tr>
            <tr>
    ...
    <div class="col-lg-12">
        <table class="table bg-putih ">
            ...
            <tr>
                ...
                <td>
                    <?php echo anchor('pulsa/hapus/'.$row->id_pulsa,'Hapus',['class'=>'btn btn-danger btn-sm']); ?></td>
            </tr>
            <?php
                $no++;
            }
